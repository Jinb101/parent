<template>
  <div class="index_notice_detail">
    ...
    <div class="content app_frame_content" v-html="detail.content"></div>
    ...
    <van-button
      v-if="detail.is_sign > 0 && !detail.sign"
      size="small"
      type="primary"
      @click="write = true"
      >签名</van-button
    ...
    <div v-if="detail.sign">
      <h5>我的签名</h5>
      <van-image :src="detail.sign" class="sign"></van-image>
    </div>
    <transition name="van-slide-left">
      <div class="app_show_fixed top" style="z-index: 580" v-if="write">
        <v-tool-title text="签名" back @on-back="write = false"></v-tool-title>
        <div class="views">
