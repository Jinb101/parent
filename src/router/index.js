...
function routerObj(path, com, name, title, to = "", child) {
  ...
  if (process.env.NODE_ENV === "development") {
    ...
    opt.component = () =>
      import(/* webpackChunkName: "lib" */ "../views/" + com);
  }
...
const router = new Router({
  routes: [
    ...
    routerObj(
      "/info_detail/:id",
      "index/info/detail.vue",
      "infoDetail",
      "园所资讯详情"
    ),
    routerObj(
      "/info_detail_detail/:id",
      "index/info/detail.vue",
      "infoDetail2",
      "园所资讯详情"
    ), // 园所触发 bug 使用
    ...
    routerObj(
      "/garden_detail",
      "index/garden/detail.vue",
      "gardenDetail",
      "园所简介"
    ),
    routerObj(
      "/garden_honor",
      "index/garden/honor.vue",
      "gardenHonor",
      "园所荣誉"
    ),
    ...
    routerObj(
      "/teach_detail/:id",
      "index/teach/detail.vue",
      "teachDetail",
      "教师风采详情"
    ),
    routerObj(
      "/teach_plan",
      "index/teach_plan/index.vue",
      "teach_plan",
      "班级课表"
    ),
    ...
    routerObj(
      "/food_history",
      "index/food/new_history.vue",
      "foodHistory",
      "历史食谱"
    ),
    routerObj(
      "/recommend",
      "index/recommend/index.vue",
      "recommend",
      "推荐有礼"
    ),
    ...
    routerObj(
      "/notice_detail/:id",
      "index/notice/detail.vue",
      "noticeDetail",
      "通知详情"
    ),
    routerObj("/baby_video", "index/video/index.vue", "videoBaby", "宝贝在线"),
    routerObj(
      "/baby_video_detail/:id",
      "index/video/detail.vue",
      "videoBabyDetail",
      "宝贝在线详情"
    ),
    ...
    routerObj(
      "/survey_add/:id&:rid",
      "index/survey/add.vue",
      "surveyAdd",
      "答题"
    ),
    routerObj(
      "/survey_detail/:id&:rid",
      "index/survey/detail.vue",
      "surveyDetail",
      "答题详情"
    ),
    routerObj(
      "/attendance",
      "index/attendance/index.vue",
      "attendance",
      "宝宝考勤"
    ),
    routerObj(
      "/attendance_punch",
      "index/attendance/punch.vue",
      "attendancePunch",
      "宝宝打卡记录"
    ),
    routerObj(
      "/attendance_leaves",
      "index/attendance/leaves.vue",
      "attendanceLeaves",
      "宝宝请假记录"
    ),
    routerObj(
      "/attendance_leave",
      "index/attendance/leave.vue",
      "attendanceLeave",
      "宝宝请假"
    ),
    ...
    routerObj(
      "/growth_task",
      "index/growth/task.vue",
      "growthTask",
      "成长任务"
    ),
    routerObj(
      "/growth_task_det/:id",
      "index/growth/task_det.vue",
      "growthTaskDet",
      "作业详情"
    ),
    routerObj(
      "/growth_integral",
      "index/growth/integral.vue",
      "growIntegral",
      "宝宝积分"
    ),
    ...
    routerObj(
      "/recommend_shop",
      "index/recommend/shop.vue",
      "recommendShop",
      "积分兑换"
    ),
    routerObj(
      "/recommend_shop_detail/:id",
      "index/recommend/shop_det.vue",
      "recommendShopDet",
      "商品详情"
    ),
    routerObj(
      "/recommend_shop_details/:id",
      "index/recommend/shop_detail.vue",
      "recommendShopDets",
      "兑换详情"
    ),
    routerObj(
      "/recommend_detail",
      "index/recommend/detail.vue",
      "recommendDetail",
      "兑换记录"
    ),
    ...
    routerObj(
      "/chant/:classid&:typeid&:tabid&:detailid",
      "chant/index.vue",
      "chant1",
      "学国学"
    ),
    routerObj(
      "/chant/:classid&:typeid&:tabid",
      "chant/index.vue",
      "chant2",
      "学国学"
    ),
    ...
    if (navigator.userAgent.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/)) {
      ...
      hackIframe.src =
        process.env.NODE_ENV === "development"
          ? "../../../"
          : "./" + "static/html/fixIosTitle.html?r=" + Math.random();
