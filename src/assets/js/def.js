...
let c2 = (name, title, num = 0, icon) => {
  icon = icon || name
  return {
    name, title, num, icon: path + 'static/image/icon/' + icon + '.png'
  }
}
let c4 = (name, title, icon) => {
  icon = icon || name
  return {
    name, title, icon: path + 'static/image/theme/' + icon + '.png'
  }
}
let c5 = (name, title, url = '', level = 0, num = 0, w = 'user') => {
  return {
    name, title, num, icon: path + 'static/image/' + w + '/' + name + '.png', level, url
  }
}
...
let c8 = (title, name, url, level = 0, color = '') => {
  return { title, icon: path + 'static/image/user/' + name + '.png', url, level, color, num: 0 }
}
